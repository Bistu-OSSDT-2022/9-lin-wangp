...
public class PoiReadingExcel1 {
    ...
    @Test
    public static void testNumber(String s) throws Exception {
        //读取文件的位置
        String path = s;
        //获取文件输入流
    ...
    @Test
    public static void testRead(int i,int j,int k,String s) throws Exception {
        //读取文件的位置
        String path = s;
        //获取文件输入流
        FileInputStream fileInputStream = new FileInputStream(path);
    ...
    public static void tp(String s)throws Exception {
